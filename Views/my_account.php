        ...
        <div class="account_section_resume">
            ...
            <div class="account_section_user_info_wrapper">
                ...
                <div class="books_count_wrapper">
                    ...
                    <p class="books_count"><?= isset($user) ? $user->getCreatedBooksCount() : "" ?> livre<?= isset($user) && $user->getCreatedBooksCount() > 1 ? "s" : "" ?></p>
                </div>

            </div>
        </div>
        <div class="account_section_form">
            <form class="update_user_info" action="index.php?page=mon_compte&action=editUserInformations" method="POST">
